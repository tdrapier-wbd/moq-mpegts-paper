...
> operating state for hours, because at the source's first PCR discontinuity the exporter's clock stops
> advancing altogether, with the wire giving no sign of it. The buffer that costs is set by the **peak coded
